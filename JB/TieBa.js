...
************************
[Script]
贴吧签到 = type=cron,cronexp=0 9 * * *,script-path= https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
贴吧获取Cookie = type=http-request,pattern=https?:\/\/(c\.tieba\.baidu\.com|180\.97\.\d+\.\d+)\/c\/s\/login,script-path= https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
[MITM] 
...
[task_local]
# 贴吧签到
0 9 * * * https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
[rewrite_local]
# 获取Cookie
https?:\/\/(c\.tieba\.baidu\.com|180\.97\.\d+\.\d+)\/c\/s\/login url script-request-header https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
[mitm] 
hostname= c.tieba.baidu.com
************************
Loon 2.1.0+ 脚本配置:
...
[Script]
# 贴吧签到
cron "0 9 * * *" script-path= https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
# 获取Cookie
http-request https?:\/\/(c\.tieba\.baidu\.com|180\.97\.\d+\.\d+)\/c\/s\/login script-path= https://raw.githubusercontent.com/Softlyx/QuantumultX/main/Scripts/TieBa.js
[Mitm] 
hostname= c.tieba.baidu.com
*/
var $nobyda = nobyda();
